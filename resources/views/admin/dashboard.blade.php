            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="p-6 flex items-center">
                        <div class="mr-4">
                            <div class="bg-white bg-opacity-20 rounded-full p-3">
                                <img src="{{ asset('svgs/clipboard-check-svgrepo-com.svg') }}" class="w-8 h-8"
                                    alt="Icon">
                            </div>
                        </div>
                        <div>
                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-lg overflow-hidden">
                    <div class="p-6 flex items-center">
                        <div class="mr-4">
                             <div class="bg-white bg-opacity-20 rounded-full p-3">
                                <img src="{{ asset('svgs/incomes-svgrepo-com.svg') }}" class="w-8 h-8"
                                    alt="Icon">
                            </div>
                        </div>
                        <div>
                            <p class="text-white text-sm font-medium">Pendapatan Total</p>
                            <h3 class="text-white text-xl font-bold">Rp {{ number_format($totalRevenue, 0, ',', '.') }}
                            </h3>
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-lg overflow-hidden">
                    <div class="p-6 flex items-center">
                        <div class="mr-4">
                            <div class="bg-white bg-opacity-20 rounded-full p-3">
                                <img src="{{ asset('svgs/user-check-svgrepo-com.svg') }}" class="w-8 h-8"
                                    alt="Icon">
                            </div>
                        </div>
                        <div>
                ...
                <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl shadow-lg overflow-hidden">
                    <div class="p-6 flex items-center">
                        <div class="mr-4">
                            <div class="bg-white bg-opacity-20 rounded-full p-3">
                                <img src="{{ asset('svgs/jet-ski-svgrepo-com.svg') }}" class="w-8 h-8"
                                    alt="Icon">
                            </div>
